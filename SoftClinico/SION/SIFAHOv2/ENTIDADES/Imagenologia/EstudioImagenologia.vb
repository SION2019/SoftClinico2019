Public Class EstudioImagenologia
    ...
    Public Sub tituloFormulario(moduloReal As String)
        Select Case moduloReal
            ...
            Case Constantes.CODIGO_MENU_LABORATORIO
                titulo = TitulosForm.TITULO_LABORATORIO
            Case Else
    ...
    Public Sub imprimirReporte()
        Try
            ...
            ElseIf tipo = Constantes.ATENCION_EXAMENES_EXT Then
            ...
            ElseIf tipo = Constantes.Tipo_documento Then
                ...
                nombreReporte = ConstantesHC.NOMBRE_PDF_LAB_EXT
