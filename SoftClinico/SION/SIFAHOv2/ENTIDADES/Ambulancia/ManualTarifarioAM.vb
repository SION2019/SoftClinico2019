Public Class ManualTarifarioAM
    ...
    Public Sub New()
        ...
        sqlGuardarManualTarifario = ConsultasAmbu.MANUAL_TARIFARIO_AM_CREAR
        sqlBuscarManualTarifarioAM = ConsultasAmbu.MANUAL_TARIFARIO_AM_BUSCAR
        sqlCargarManualTarifarioAM = ConsultasAmbu.MANUAL_TARIFARIO_AM_CARGAR
        sqlAnularManualTarifario = ConsultasAmbu.MANUAL_TARIFARIO_AM_ANULAR
    End Sub
