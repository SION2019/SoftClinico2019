Public Class Tripulante
    ...
    Public Sub New()
        sqlGuardarTarifaTripulacion = ConsultasAmbu.TARIFA_TRIPULACION_CREAR
        sqlBuscarTarifaTripulacion = ConsultasAmbu.TARIFA_TRIPULACION_BUSCAR
        sqlCargarTarifaTripulacion = ConsultasAmbu.TARIFA_TRIPULACION_CARGAR
        sqlAnularTarifaTripulacion = ConsultasAmbu.TARIFA_TRIPULACION_ANULAR
        sqlBuscarResponsableTarifaTripulacion = ConsultasAmbu.TARIFA_TRIPULACION_RESPONSABLE_BUSCAR
        sqlCargarResponsableTarifaTripulacion = ConsultasAmbu.TARIFA_TRIPULACION_RESPONSABLE_CARGAR
    End Sub
