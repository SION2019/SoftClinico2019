Public Class AtencionLaboratorio
    ...
    Public Property objVistaPrevia As New VistaPreviaAtencion
    Public Property objConsolidado As ConsolidadoAtencion
    ...
    Public Property codigoProcedimiento As New List(Of String)
    ...
    Public Sub crearConsolidado()
        objConsolidado = New ConsolidadoAtencion
        objConsolidado.codigoAtencion = codigoAtencion
    ...
    Public Sub generarVistaPrevia(pUsuario As Integer, pNombrePaciente As String, ByRef formPlataforma As FormVisorPlataformaDoc)
        objVistaPrevia.registro = codigoAtencion
