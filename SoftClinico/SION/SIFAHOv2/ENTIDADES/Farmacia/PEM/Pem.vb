...
Public Class Pem
    ...
    Public Property codigoPemPunto As String
    ...
    Public Property tablaAdvertencia As DataTable
    ...
    Sub New()
        ...
        tablaAdvertencia = New DataTable

        tablaAdvertencia.Columns.Add("Descripcion", Type.GetType("System.String"))
        tablaAdvertencia.Columns.Add("Cantidad", Type.GetType("System.Int32"))
        tablaAdvertencia.Columns.Add("Tipo", Type.GetType("System.String"))
