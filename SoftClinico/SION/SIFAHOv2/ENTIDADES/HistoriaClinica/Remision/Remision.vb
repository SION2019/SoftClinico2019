Public Class Remision
    ...
    Public Property remisionExterna As Integer
    ...
    Public Property enviadoVerificar As Integer
    Sub New()
    ...
    Public Sub cargarRemision()
        ...
        If dt.Rows.Count > 0 Then
            ...
            fechaRemision = dt.Rows(0).Item("Fecha_remision").ToString
            If moduloReporte = 0 Then
                enviado = Funciones.castFromDbItem(dt.Rows(0).Item("enviado"))
            End If

            If dt.Rows(0).Item("Remision_externa").ToString = "" Then
                remisionExterna = -1
            Else
                remisionExterna = dt.Rows(0).Item("Remision_externa").ToString
            End If
