Public Class SolicitudMedicamentosNoPos
    ...
    Public Sub cargarPaciente()
        ...
        If modulo = Constantes.AM Then
            consultaCargar = Consultas.PACIENTE_DATOS_CARGAR_R
        ElseIf modulo = Constantes.AF Then
            consultaCargar = Consultas.PACIENTE_DATOS_CARGAR_RR
        Else
            consultaCargar = Consultas.PACIENTE_DATOS_CARGAR
        End If
    ...
    Public Sub cargarDemasRegistro()
        Dim consultaCargar As String
        If modulo = Constantes.AM Then
            consultaCargar = Consultas.SOLIC_MED_CARGAR_REGISTROS_R
        ElseIf modulo = Constantes.AF Then
            consultaCargar = Consultas.SOLIC_MED_CARGAR_REGISTROS_RR
        Else
            consultaCargar = Consultas.SOLIC_MED_CARGAR_REGISTROS
        End If
        Dim dt As New DataTable
        Dim params As New List(Of String)
        params.Add(Codigo)
