    ...
    Public Sub codigotipo()
        ...
        Try
            If codigoMenu = Constantes.CODIGO_MENU_ECOSTRES_HC _
                                ...
                                Or codigoMenu = Constantes.CODIGO_MENU_ECOSTRES_AF _
                                Or codigoMenu = Constantes.CODIGO_MENU_ECOSTRES_HOSP _
                                Or codigoMenu = Constantes.CODIGO_MENU_ECOSTRES_URG _
                                Or codigoMenu = Constantes.CODIGO_MENU_ECOSTRES_HEMO _
                                Or codigoMenu = Constantes.CODIGO_MENU_ECOSTRES_CEXT Then
