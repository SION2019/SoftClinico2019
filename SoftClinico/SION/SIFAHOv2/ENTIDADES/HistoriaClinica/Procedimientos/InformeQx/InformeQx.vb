Public Class InformeQx
    ...
    Public Property codigoAnestesia As String
    Public Property idAnestesiologo As String
    Public Property idViaAbordQX As String
    Public Property idViaAbrdAnestesia As Integer
    Public Property tipoAnestesia As Integer
    ...
    'Dim idAyudante As Integer
    'Dim idAnestesiologo As Integer
    'Dim idViaAbordQX As Integer
    'Dim idViaAbrdAnestesia As Integer
    Public Sub New()
    ...
    Public Property setGetCodigoMedico As String
        Get
            Return idAnestesiologo
        End Get
        Set(value As String)
            idAnestesiologo = If(value = -1, Nothing, value)
        End Set
    End Property
