Public Class PedidoComida
    ...
    Sub New()
        ...
        tblComida.Columns.Add("Suspender", Type.GetType("System.Boolean"))
        tblComida.Columns.Add("Observacion", Type.GetType("System.String"))
        ...
        tblComida.Columns("Suspender").DefaultValue = False
