Public Class EquivalenciaInventario
    ...
    Public Property descripcionATC As String
    Public Property grupoATC As String
    ...
    Public Sub CreaOpciones(codigo As String, ByRef arbol As TreeView, ByRef ds As DataSet)
        ...
        cadena = "EXEC PROC_VIASADMINISTRATIVA_BUSCAR ''"
        Try
            ...
            If codigo = "" Then
                codigo = -1
            End If
            cadena = "EXEC [PROC_VIAS_ADMON_EQUIVALENCIA] " & codigo & ""
