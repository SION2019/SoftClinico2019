Public Class FormCarteraCXC
    ...
    Private Sub llenardgv(pCodigo As DateTime, idempresa As Integer)
        ...
        General.llenarTabla(Consultas.CARTERA_CXC_CUENTAS_CARGAR, params, dtCartera)
    ...
    Private Sub cargarDatos(pCodigo As String)
        ...
        General.llenarTabla(Consultas.CARTERA_CXC_CARGAR, params, dt)
        Textsigla.Text = Constantes.SIGLA_SALDOS_INICIALES
    ...
    Private Sub btbuscar_Click(sender As Object, e As EventArgs) Handles btbuscar.Click
        If SesionActual.tienePermiso(PBuscar) Then
            ...
            General.buscarElemento(Consultas.CARTERA_CXC_BUSCAR,
                                   params,
    ...
    Private Sub dgvcartera_KeyDown(sender As Object, e As KeyEventArgs) Handles dgvCartera.KeyDown
        ...
        If e.KeyCode = Keys.F3 And btguardar.Enabled = True Then
            General.busquedaItems(Consultas.FACTURAS_CXC_BUSCAR, params, TitulosForm.BUSQUEDA_CAJA_BANCO, dgvCartera, dtCartera, 0, 4, 0, 0)
        End If
    End Sub
        ...
        Else
            For i = 0 To dgvCartera.Rows.Count - 1
                If dgvCartera.Rows(i).Cells("cuenta").Value.ToString = "" Then
                    MsgBox("El Tercero " + dgvCartera.Rows(i).Cells("Tercero").Value.ToString.ToLower + " no tiene cuenta configurada", 48, "Atención")
                    Return False
                End If
            Next
        End If
        ...
        For Each drFila As DataRow In dtCartera.Rows
            If drFila.Item("Factura").ToString <> "" Then
                ...
                If String.IsNullOrEmpty(identificador) Then
                    drCuentaP.Item("comprobante") = FuncionesContables.verificarConsecutivo(SesionActual.idEmpresa, codigoDocumento)
                Else
