Public Class InformeQx
    ...
    Public Sub anularInformeQX(activoAM As Boolean, activoAF As Boolean)
        ...
        ftp_reportes.eliminarArchivo(ConstantesHC.NOMBRE_PDF_INFORMEQX & ConstantesHC.NOMBRE_PDF_SEPARADOR & codigo & ConstantesHC.EXTENSION_ARCHIVO_PDF)
        If activoAM = True Then
            ftp_reportes.eliminarArchivo(ConstantesHC.NOMBRE_PDF_INFORMEQX_R & ConstantesHC.NOMBRE_PDF_SEPARADOR & codigo & ConstantesHC.EXTENSION_ARCHIVO_PDF)
        End If
        If activoAF = True Then
            ftp_reportes.eliminarArchivo(ConstantesHC.NOMBRE_PDF_INFORMEQX_RR & ConstantesHC.NOMBRE_PDF_SEPARADOR & codigo & ConstantesHC.EXTENSION_ARCHIVO_PDF)
        End If
