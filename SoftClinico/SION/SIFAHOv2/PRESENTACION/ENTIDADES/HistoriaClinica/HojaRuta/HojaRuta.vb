Public Class HojaRuta
    ...
    Public Sub New()
        ...
        dtProgram.Columns.Add("Descripcion", Type.GetType("System.String"))
        dtProgram.Columns.Add("id_Empleado", Type.GetType("System.Int32"))
        dtProgram.Columns.Add("Empleado", Type.GetType("System.String"))
    ...
    End Sub
    Public Sub validarOcultoDgv()
        Select Case vista
            Case Constantes.REPORTE_HC
                columnaHC = True
            Case Constantes.REPORTE_AM
                columnaHC = True
                columnaAM = True
            Case Constantes.REPORTE_AF
                columnaHC = True
                columnaAM = True
                columnaAF = True
        End Select
