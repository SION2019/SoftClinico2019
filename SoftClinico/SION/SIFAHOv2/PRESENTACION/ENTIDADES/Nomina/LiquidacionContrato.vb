Public Class LiquidacionContrato
    ...
    Sub New()
        ...
        dtCxp = New DataTable
        dtLiquidacion.Columns.Add("Contrato", Type.GetType("System.Int32"))
        ...
        dtLiquidacion.Columns.Add("Base.Liquidación", Type.GetType("System.Double"))
        ...
        dtLiquidacion.Columns.Add("Neto.Pagar", Type.GetType("System.Int32"))
        ...
        dtCxp.Columns.Add("Observacion", Type.GetType("System.String"))
    ...
    Public Sub llenarCuentas()
        For indiceLiquidacion = 0 To dtLiquidacion.Rows.Count - 1
            ...
            dtCxp.Rows(0).Item("codigoFactura") = dtLiquidacion.Rows(indiceLiquidacion).Item("Contrato")
            ...
            dtCxp.Rows(0).Item("Observacion") = Constantes.OBSERVACION_LIQUIDACION
            dtCxp.Rows(0).Item("valorDebito") = dtLiquidacion.Rows(indiceLiquidacion).Item("Neto.Pagar")
            dtCxp.Rows(0).Item("valorCredito") = dtLiquidacion.Rows(indiceLiquidacion).Item("Neto.Pagar")
