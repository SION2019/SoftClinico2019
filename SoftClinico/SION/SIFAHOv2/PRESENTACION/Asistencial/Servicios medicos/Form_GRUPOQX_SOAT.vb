Public Class Form_GRUPOQX_SOAT
    Dim enlce_dta As BindingSource = New BindingSource
    Dim i, c As Integer
    Dim cups As New GRUPOQX_D
    ...
    Private Sub TextBox1_TextChanged(sender As Object, e As EventArgs) Handles TextBox1.TextChanged
        ...
        enlce_dta.Filter = "[Código] LIKE '%" + TextBox1.Text.Trim() + "%' or [Descripción] LIKE '%" + TextBox1.Text.Trim() + "%' or [Honorarios Médicos] LIKE '%" + TextBox1.Text.Trim() + "%' or [Honorarios Anesteciólogo] LIKE '%" + TextBox1.Text.Trim() + "%'  or [Derecho de sala] LIKE '%" + TextBox1.Text.Trim() + "%' or [Materiales] LIKE '%" + TextBox1.Text.Trim() + "%'  or [Honorarios ayudante] LIKE '%" + TextBox1.Text.Trim() + "%' or [Honorarios perfusión] LIKE '%" + TextBox1.Text.Trim() + "%' "
    End Sub
    ...
    Private Sub Form_GRUPOQX_SOAT_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        llenar_dgv()
    End Sub
    ...
    Public Sub llenar_dgv()
        ...
        If dt.Rows.Count > 0 Then
            ...
            Next
            dgvprocedimiento.Columns(i - 7).AutoSizeMode = DataGridViewAutoSizeColumnMode.None
