Public Class Form_GRUPO_SOAT
    Dim enlce_dta As BindingSource = New BindingSource
    Dim i, c As Integer
    Dim cups As New GRUPO_D
    ...
    Private Sub Form_GRUPO_SOAT_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        llenar_dgv()
    End Sub
    ...
    Public Sub llenar_dgv()
        ...
        If dt.Rows.Count > 0 Then
            ...
            dgvprocedimiento.Columns(i - 2).AutoSizeMode = DataGridViewAutoSizeColumnMode.None
    ...
    Private Sub dgvprocedimiento_EditingControlShowing(sender As Object, e As DataGridViewEditingControlShowingEventArgs) Handles dgvprocedimiento.EditingControlShowing
        If dgvprocedimiento.Columns("VMIN").Index = dgvprocedimiento.CurrentCell.ColumnIndex OrElse dgvprocedimiento.Columns("VMAX").Index = dgvprocedimiento.CurrentCell.ColumnIndex Then
