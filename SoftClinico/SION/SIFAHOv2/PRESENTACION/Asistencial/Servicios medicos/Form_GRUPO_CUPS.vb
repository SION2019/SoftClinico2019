Public Class Form_GRUPO_CUPS
    Dim enlce_dta As BindingSource = New BindingSource
    Dim i, c As Integer
    Dim cups As New GCUPS_D
    ...
    Private Sub btguardar_Click(sender As Object, e As EventArgs) Handles btguardar.Click
        ...
        Try
            ...
            If cups.guardar(dgvprocedimiento, SesionActual.idUsuario) = True Then
    ...
    Private Sub dgvprocedimiento_CellDoubleClick(sender As Object, e As DataGridViewCellEventArgs) Handles dgvprocedimiento.CellDoubleClick
        If btguardar.Enabled = True Then
            If e.ColumnIndex = 6 Or e.ColumnIndex = 7 Then
                ...
                Dim formBusqueda As Form_BusquedaGeneral = General.buscarElemento(Consultas.BUSQUEDA_CAPITULO_CUPS, Nothing, TitulosForm.BUSQUEDA_CAPITULO_CUPS, True)
                tbl = formBusqueda.rowResultados
                If tbl IsNot Nothing Then
                    dt.Rows(dgvprocedimiento.CurrentCell.RowIndex).Item("Capitulo") = tbl(0)
                    dt.Rows(dgvprocedimiento.CurrentCell.RowIndex).Item("Descripción capitulo") = tbl(1)
                End If
    ...
    Private Sub Form_GRUPO_CUPS_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        llenar_dgv()
    End Sub
