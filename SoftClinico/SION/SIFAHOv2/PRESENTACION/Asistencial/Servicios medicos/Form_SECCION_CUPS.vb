Public Class Form_SECCION_CUPS
    Public buscar_S As Boolean
    Dim enlce_dta As BindingSource = New BindingSource
    Dim i, c As Integer
    Dim cups As New SCUPS_D
    ...
    Private Sub Form_SECCION_CUPS_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        llenar_dgv()
    End Sub
