...
Public Class Form_causa_externa
    ...
    Private Sub btguardar_Click(sender As Object, e As EventArgs) Handles btguardar.Click
        ...
        Else
            If MsgBox(Mensajes.GUARDAR, MsgBoxStyle.Question + MsgBoxStyle.YesNo, TitulosForm.GUARDAR) = MsgBoxResult.Yes Then
                Try
                    cargarObjeto()
                    CausaExternaBLL.guardarCausaexterna(objconfiguracion)
                    ...
                    If General.verificar_formulario(FormAdmision) = True Then
                        General.cargarCombo(Consultas.CAUSA_EXTERNA_LISTAR,
                                        "Descripcion_Causa",
                                        "Codigo_Causa",
                                        FormAdmision.Combocausa)
                    End If
    ...
    Private Sub btanular_Click(sender As Object, e As EventArgs) Handles btanular.Click
        ...
        If SesionActual.tienePermiso(Panular) Then
            If MsgBox(Mensajes.ANULAR, MsgBoxStyle.Question + MsgBoxStyle.YesNo, TitulosForm.GUARDAR) = MsgBoxResult.Yes Then
                Try
                    If General.anularConValidacion(Consultas.CAUSA_EXTERNA_ANULAR &
                    ...
                    Else
                        MsgBox(Mensajes.NO_ANULAR_CAUSA_EXTERNA, MsgBoxStyle.Information)
                    End If
                Catch ex As Exception
                    General.manejoErrores(ex)
                End Try
    ...
    Private Sub btbuscar_Click(sender As Object, e As EventArgs) Handles btbuscar.Click
        If SesionActual.tienePermiso(PBuscar ) Then
            ...
            General.buscarElemento(Consultas.CAUSA_EXTERNA_BUSCAR,
                                   Nothing,
                                   AddressOf cargarCausaExterna,
                                   TitulosForm.BUSQUEDA_CAUSA_EXTERNA,
                                   False, 0, True)
        Else
           MsgBox(Mensajes.SINPERMISO, MsgBoxStyle.Exclamation)
        End If
    End Sub
    Public Sub cargarCausaExterna(pCodigo As String)
        Dim dr As DataRow
        Dim params As New List(Of String)

        params.Add(pCodigo)
        dr = General.cargarItem(Consultas.CAUSA_EXTERNA_CARGAR, params)
