...
Public Class Form_estado_civil
    ...
    Private Sub btguardar_Click(sender As Object, e As EventArgs) Handles btguardar.Click
        ...
        If String.IsNullOrWhiteSpace(txtnombre.Text) Then
            Exec.SavingMsg("¡ Por favor digite el nombre de este estado civil !", txtnombre)
        Else
            If MsgBox(Mensajes.GUARDAR, MsgBoxStyle.Question + MsgBoxStyle.YesNo, TitulosForm.GUARDAR) = MsgBoxResult.Yes Then
                Try
                    cargarObjeto()
                    EstadoCivilBLL.guardarEstadoCivil(objConfiguracion)
    ...
    Private Sub btanular_Click(sender As Object, e As EventArgs) Handles btanular.Click
        ...
        If SesionActual.tienePermiso(Panular) Then
            If MsgBox(Mensajes.ANULAR, MsgBoxStyle.Question + MsgBoxStyle.YesNo, TitulosForm.GUARDAR) = MsgBoxResult.Yes Then
                Try
                    If General.anularConValidacion(Consultas.ESTADO_CIVIL_ANULAR &
                                               txtcodigo.Text & ConstantesHC.NOMBRE_PDF_SEPARADOR3 &
                    ...
                    Else
                        MsgBox(Mensajes.NO_ANULAR_ESTADO_CIVIL, MsgBoxStyle.Information)
                    End If
                Catch ex As Exception
                    General.manejoErrores(ex)
                End Try
    ...
    Private Sub btbuscar_Click(sender As Object, e As EventArgs) Handles btbuscar.Click
        ...
        General.buscarElemento(Consultas.ESTADO_LISTAR,
                               Nothing,
                               AddressOf cargarEstadoCivil,
                               TitulosForm.BUSQUEDA_ESTADOCIVIL,
                               False, 0, True)


    End Sub

    Public Sub cargarEstadoCivil(pCodigo As String)
        Dim drEstadoCivil As DataRow
        Dim params As New List(Of String)

        params.Add(pCodigo)

        drEstadoCivil = General.cargarItem(Consultas.ESTADO_CIVIL_CARGAR, params)

        txtcodigo.Text = pCodigo
        txtnombre.Text = drEstadoCivil.Item(0)
    ...
    Private Sub otrasValidacines()
        If General.verificar_formulario(Form_paciente) = True Then
            General.cargarCombo(Consultas.ESTADO_LISTAR, "Estado Civil",
                                "Codigo",
                                formPaciente.comboestado)
        End If
    End Sub
End Class