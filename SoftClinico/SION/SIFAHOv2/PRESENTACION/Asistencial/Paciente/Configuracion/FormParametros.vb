Public Class FormParametros
    ...
    Private Sub Tiposidentificacion_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        permiso_general = perG.buscarPermisoGeneral(parametroExamen.Name)
    ...
    Private Sub btguardar_Click(sender As Object, e As EventArgs) Handles btguardar.Click
        ...
        If String.IsNullOrWhiteSpace(txtnombre.Text) Then
            Exec.SavingMsg("¡ Por favor digite el nombre del parametro!", txtnombre)
        Else
            If MsgBox(Mensajes.GUARDAR, MsgBoxStyle.Question + MsgBoxStyle.YesNo, TitulosForm.GUARDAR) = MsgBoxResult.Yes Then
                Try
                    cargarObjeto()
                    ParametroBLL.guardarParametro(objConfiguracion)
    ...
    Private Sub btanular_Click(sender As Object, e As EventArgs) Handles btanular.Click
        ...
        If SesionActual.tienePermiso(Panular) Then
            If MsgBox(Mensajes.ANULAR, MsgBoxStyle.Question + MsgBoxStyle.YesNo, TitulosForm.ANULAR) = MsgBoxResult.Yes Then
                Try
                    If General.anularConValidacion(Consultas.PARAMETROS_ANULAR &
                                             txtcodigo.Text &
                        ...
                        validaciones()
                    Else
                        MsgBox(Mensajes.NO_ANULAR_PARAMETRO, MsgBoxStyle.Information)
                    End If
                Catch ex As Exception
                    General.manejoErrores(ex)
                End Try
    ...
    Private Sub btbuscar_Click(sender As Object, e As EventArgs) Handles btbuscar.Click
        If SesionActual.tienePermiso(PBuscar) Then
            General.buscarElemento(Consultas.PARAMETROS_BUSCAR,
                                   Nothing,
                                   AddressOf cargar,
                                   TitulosForm.BUSQUEDA_PARAMETRO,
                                   False, 0, True)
        Else
            MsgBox(Mensajes.SINPERMISO, MsgBoxStyle.Exclamation)
        End If
    ...
    Public Sub cargar(pCodigo As String)
        ...
        params.Add(pCodigo)
        drTipoAfiliacion = General.cargarItem(Consultas.PARAMETROS_CARGAR,
                                              params)
    ...
    Private Sub validaciones()
        If General.verificar_formulario(FormParametroExamConfiguracion) = True Then
            parametroExamen.cargarParametroExam()
        End If
    End Sub
End Class