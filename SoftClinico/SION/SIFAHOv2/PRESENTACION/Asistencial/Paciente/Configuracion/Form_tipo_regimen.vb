Public Class Form_tipo_regimen
    Dim objConfiguracion As New ConfiguracionGeneral
    Dim perG As New Buscar_Permisos_generales
    Dim permiso_general, Pnuevo, Peditar, Panular, PBuscar As String
    Public Property formAfiliacion As Form_afiliados
    ...
    Private Sub btguardar_Click(sender As Object, e As EventArgs) Handles btguardar.Click
        ...
        If String.IsNullOrWhiteSpace(txtnombre.Text) Then
            Exec.SavingMsg("¡ Por favor digite el nombre del regimen !", txtnombre)
        Else
            If MsgBox(Mensajes.GUARDAR, MsgBoxStyle.Question + MsgBoxStyle.YesNo, TitulosForm.GUARDAR) = MsgBoxResult.Yes Then
                Try
                    cargarObjeto()
                    TipoRegimenBLL.guardarTipoRegimen(objConfiguracion)
                    ...
                    If General.verificar_formulario(Form_afiliados) = True Then
                        General.cargarCombo(Consultas.TIPO_REGIMEN_BUSCAR, "Descripcion_Regimen", "Codigo_Regimen", formAfiliacion.Combobeneficiario)
                    End If
    ...
    Private Sub btanular_Click(sender As Object, e As EventArgs) Handles btanular.Click
        ...
        If SesionActual.tienePermiso(Panular) Then
            If MsgBox(Mensajes.ANULAR, MsgBoxStyle.Question + MsgBoxStyle.YesNo, TitulosForm.ANULAR) = MsgBoxResult.Yes Then
                Try
                    If General.anularConValidacion(Consultas.TIPO_REGIMEN_ANULAR &
                                               txtcodigo.Text &
                    ...
                    Else
                        MsgBox(Mensajes.NO_ANULAR_TIPO_REGIMEN, MsgBoxStyle.Information)
                    End If
                Catch ex As Exception
                    General.manejoErrores(ex)
                End Try
    ...
    Private Sub btbuscar_Click(sender As Object, e As EventArgs) Handles btbuscar.Click
        ...
        General.buscarElemento(Consultas.TIPO_REGIMEN_BUSCAR,
                               Nothing,
                               AddressOf cargarTipoRegimen,
                               TitulosForm.BUSQUEDA_REGIMEN,
                               False, 0, True)
    End Sub

    Public Sub cargarTipoRegimen(pCodigo As String)
