Public Class Form_ocupaciones
    ...
    Private Sub btguardar_Click(sender As Object, e As EventArgs) Handles btguardar.Click
        ...
        If String.IsNullOrWhiteSpace(txtnombre.Text) Then
            Exec.SavingMsg("¡ Por favor digite el nombre de la ocupaciòn!", txtnombre)
        Else
            If MsgBox(Mensajes.GUARDAR, MsgBoxStyle.Question + MsgBoxStyle.YesNo, TitulosForm.GUARDAR) = MsgBoxResult.Yes Then
                Try
                    cargarObjeto()
                    OcupacionBLL.guardarOcupaciones(objConfiguracion)
    ...
    Private Sub btanular_Click(sender As Object, e As EventArgs) Handles btanular.Click
        ...
        If SesionActual.tienePermiso(Panular) Then
            If MsgBox(Mensajes.ANULAR, MsgBoxStyle.Question + MsgBoxStyle.YesNo, TitulosForm.ANULAR) = MsgBoxResult.Yes Then
                Try
                    If General.anularConValidacion(Consultas.OCUPACION_ANULA &
                                               txtcodigo.Text &
                    ...
                    Else
                        MsgBox(Mensajes.NO_ANULAR_OCUPACION, MsgBoxStyle.Information)
                    End If
                Catch ex As Exception
                    General.manejoErrores(ex)
                End Try
    ...
    Private Sub btbuscar_Click(sender As Object, e As EventArgs) Handles btbuscar.Click
        General.buscarElemento(Consultas.OCUPACION_LISTAR,
                               Nothing,
                               AddressOf cargarOcupacion,
                               TitulosForm.BUSQUEDA_OCUPACION,
                               False, 0, True)

    End Sub

    Public Sub cargarOcupacion(pCodigo As String)
        Dim drOcupacion As DataRow
        Dim params As New List(Of String)
        params.Add(pCodigo)

        drOcupacion = General.cargarItem(Consultas.OCUPACION_CARGA, params)

        txtcodigo.Text = pCodigo
        txtnombre.Text = drOcupacion.Item(0)
    ...
    Private Sub otrasValidaciones()
        If General.verificar_formulario(Form_paciente) = True Then
            General.cargarCombo(Consultas.OCUPACION_LISTAR, "Ocupaciones",
                                "Codigo",
                                formPaciente.comboocupacion)
        End If
    End Sub
End Class