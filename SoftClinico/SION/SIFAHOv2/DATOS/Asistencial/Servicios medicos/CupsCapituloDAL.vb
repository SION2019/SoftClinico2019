...
Public Class CupsCapituloDAL
    Public Function guardar(ByRef dgvprocedimiento As DataGridView) As Boolean
        ...
        cdna_insert = "INSERT INTO M_CAPITULOS_CUPS(Codigo_Capitulo,Descripcion ,Codigo_Seccion) VALUES("
        cdna_update = "UPDATE M_CAPITULOS_CUPS SET Codigo_Capitulo='_valor1',Descripcion='_valor2',Codigo_Seccion='_valor3' WHERE Codigo_Capitulo='_condicion'"
        cdna_delete = "DELETE M_CAPITULOS_CUPS WHERE Codigo_Capitulo='_condicion'"
        Try
                ...
                Using trnsccion = FormPrincipal.cnxion.BeginTransaction()
                    ...
                    For i = 0 To dgvprocedimiento.RowCount - 1
                        ...
                        If dgvprocedimiento.Rows(i).Cells("Inserción").Value = True Then
                            bndra = Validar_dgv(i, clmna_inicio, clmna_fin, dgvprocedimiento)
                            If bndra Then
                        ...
                        ElseIf dgvprocedimiento.Rows(i).Cells("Eliminación").Value = True Then
                            cdna = Replace(cdna_delete, "_condicion", dgvprocedimiento.Rows(i).Cells(clmna_inicio - 1).Value.ToString())
        ...
        End Try
    End Function
    Private Function Validar_dgv(fila_actual As Integer, clmna_inicio As Integer, clmna_fin As Integer, ByRef dgvprocedimiento As DataGridView) As Boolean
        Dim bndra As Boolean
        Dim i As Integer
