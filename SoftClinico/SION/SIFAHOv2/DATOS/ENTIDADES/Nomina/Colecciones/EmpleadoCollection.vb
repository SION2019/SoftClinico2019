...
Public Class EmpleadoCollection
    ...
    Private Iterator Function IEnumerable_GetEnumerator() As IEnumerator(Of SqlDataRecord) Implements IEnumerable(Of SqlDataRecord).GetEnumerator
        ...
        Dim sqlDataRecord As New SqlDataRecord(New SqlMetaData() {
                                                ...
                                                New SqlMetaData("registroMedico", SqlDbType.NVarChar, 50),
        ...
        For Each item As Empleado In Me
            ...
            sqlDataRecord.SetString(2, item.iniciales)
            sqlDataRecord.SetString(3, item.registroMedico)
            ...
            sqlDataRecord.SetString(15, item.codigoPaisNac)
            sqlDataRecord.SetString(16, item.codigoDepartamentoNac)
            sqlDataRecord.SetString(17, item.codigoMunicipioNac)
            sqlDataRecord.SetInt32(18, item.codigoEspecialidad)
            ...
            sqlDataRecord.SetString(24, item.tipoRH)
