Public Class RemisionProducto
    Public Property codigoRemisionPunto As String
    ...
    Public Sub agredarColumnasDataSet(ByVal nombreTabla As String, ByVal tipo As Integer, ByVal bodega As Integer)
        ...
        tblLotesMedIns.Tables(nombreTabla).Columns.Add("Precio", Type.GetType("System.Double"))
        ...
        tblLotesMedIns.Tables(nombreTabla).Columns("Precio").DefaultValue = 0
        tblLotesMedIns.Tables(nombreTabla).Columns("Total").DefaultValue = 0
        tblLotesMedIns.Tables(nombreTabla).Columns("Total").Expression = ("Cantidad*Precio")
    End Sub
End Class
