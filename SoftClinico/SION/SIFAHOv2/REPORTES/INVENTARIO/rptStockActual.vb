...
Public Class rptStockActual
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Celer.rptStockActual.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Bodega() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptStockActual
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptStockActual = New rptStockActual()
        rpt.Site = Me.Site
        Return rpt
    End Function
