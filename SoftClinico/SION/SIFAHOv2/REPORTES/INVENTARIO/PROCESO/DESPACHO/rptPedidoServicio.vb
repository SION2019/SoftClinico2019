...
Public Class rptPedidoServicio
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Celer.rptPedidoServicio.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPedidoServicio
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPedidoServicio = New rptPedidoServicio()
        rpt.Site = Me.Site
        Return rpt
    End Function
