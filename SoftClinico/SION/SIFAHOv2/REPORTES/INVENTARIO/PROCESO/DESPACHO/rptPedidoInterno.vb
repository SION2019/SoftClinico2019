...
Public Class rptPedidoInterno
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Celer.rptPedidoInterno.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPedidoInterno
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPedidoInterno = New rptPedidoInterno()
        rpt.Site = Me.Site
        Return rpt
    End Function
