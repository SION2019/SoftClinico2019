...
Public Class rptCuentaCobro
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Celer.rptCuentaCobro.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCuentaCobro
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCuentaCobro = New rptCuentaCobro()
        rpt.Site = Me.Site
        Return rpt
    End Function
