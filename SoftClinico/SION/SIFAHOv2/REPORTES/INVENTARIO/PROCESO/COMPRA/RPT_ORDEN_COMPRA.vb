...
Public Class RPT_ORDEN_COMPRA
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Celer.RPT_ORDEN_COMPRA.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_valor_en_letras() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedRPT_ORDEN_COMPRA
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_ORDEN_COMPRA = New RPT_ORDEN_COMPRA()
        rpt.Site = Me.Site
        Return rpt
    End Function
