...
Public Class rptFacturaCapita
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Celer.rptFacturaCapita.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptFacturaCapita
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptFacturaCapita = New rptFacturaCapita()
        rpt.Site = Me.Site
        Return rpt
    End Function
