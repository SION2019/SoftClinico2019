...
Public Class rptFacturaExterna
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Celer.rptFacturaExterna.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptFacturaExterna
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptFacturaExterna = New rptFacturaExterna()
        rpt.Site = Me.Site
        Return rpt
    End Function
