...
Public Class rptRespuestaGlosa
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Celer.rptRespuestaGlosa.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptRespuestaGlosa
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptRespuestaGlosa = New rptRespuestaGlosa()
        rpt.Site = Me.Site
        Return rpt
    End Function
