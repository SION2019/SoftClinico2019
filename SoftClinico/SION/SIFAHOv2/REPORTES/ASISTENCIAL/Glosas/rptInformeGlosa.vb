...
Public Class rptInformeGlosa
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Celer.rptInformeGlosa.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptInformeGlosa
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptInformeGlosa = New rptInformeGlosa()
        rpt.Site = Me.Site
        Return rpt
    End Function
