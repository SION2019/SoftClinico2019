...
Public Class rptNotaAuditoria
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Celer.rptNotaAuditoria.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptNotaAuditoria
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptNotaAuditoria = New rptNotaAuditoria()
        rpt.Site = Me.Site
        Return rpt
    End Function
