...
Public Class rptListaPrecio
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Celer.rptListaPrecio.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptListaPrecio
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptListaPrecio = New rptListaPrecio()
        rpt.Site = Me.Site
        Return rpt
    End Function
