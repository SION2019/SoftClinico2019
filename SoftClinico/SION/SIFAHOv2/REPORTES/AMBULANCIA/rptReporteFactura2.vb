...
Public Class rptReporteFactura2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Celer.rptReporteFactura2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptReporteFactura2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptReporteFactura2 = New rptReporteFactura2()
        rpt.Site = Me.Site
        Return rpt
    End Function
