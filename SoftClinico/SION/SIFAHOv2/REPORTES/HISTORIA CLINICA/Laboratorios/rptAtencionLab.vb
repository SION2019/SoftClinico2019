...
Public Class rptAtencionLab
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Celer.rptAtencionLab.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptAtencionLab
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptAtencionLab = New rptAtencionLab()
        rpt.Site = Me.Site
        Return rpt
    End Function
