...
Public Class rptInfeccionIH
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Celer.rptInfeccionIH.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptInfeccionIH
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptInfeccionIH = New rptInfeccionIH()
        rpt.Site = Me.Site
        Return rpt
    End Function
