...
Public Class rptDisentimiento
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIFAHOv2.rptDisentimiento.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptDisentimiento
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptDisentimiento = New rptDisentimiento()
        rpt.Site = Me.Site
        Return rpt
    End Function
