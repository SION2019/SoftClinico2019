...
Public Class rptEstanciaProlongada
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptEstanciaProlongada.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIFAHOv2.rptEstanciaProlongada.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptEstanciaProlongada
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptEstanciaProlongada = New rptEstanciaProlongada()
        rpt.Site = Me.Site
        Return rpt
    End Function
