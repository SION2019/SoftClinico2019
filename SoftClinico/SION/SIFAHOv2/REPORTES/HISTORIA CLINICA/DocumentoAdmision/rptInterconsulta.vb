...
Public Class rptInterconsulta
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIFAHOv2.rptInterconsulta.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptInterconsulta
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptInterconsulta = New rptInterconsulta()
        rpt.Site = Me.Site
        Return rpt
    End Function
