...
Public Class rptEvolucionMedica
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIFAHOv2.rptEvolucionMedica.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptEvolucionMedica
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptEvolucionMedica = New rptEvolucionMedica()
        rpt.Site = Me.Site
        Return rpt
    End Function
