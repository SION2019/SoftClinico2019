...
Public Class rptCasoProblema
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Celer.rptCasoProblema.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCasoProblema
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCasoProblema = New rptCasoProblema()
        rpt.Site = Me.Site
        Return rpt
    End Function
