...
Public Class rptEmbarazoParto
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Celer.rptEmbarazoParto.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptEmbarazoParto
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptEmbarazoParto = New rptEmbarazoParto()
        rpt.Site = Me.Site
        Return rpt
    End Function
