...
Public Class CertificadoSoat
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Celer.CertificadoSoat.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCertificadoSoat
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CertificadoSoat = New CertificadoSoat()
        rpt.Site = Me.Site
        Return rpt
    End Function
