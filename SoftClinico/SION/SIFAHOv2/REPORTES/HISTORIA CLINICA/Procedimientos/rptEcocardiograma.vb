...
Public Class rptEcocardiograma
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIFAHOv2.rptEcocardiograma.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptEcocardiograma
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptEcocardiograma = New rptEcocardiograma()
        rpt.Site = Me.Site
        Return rpt
    End Function
