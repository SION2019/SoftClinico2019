...
Public Class rptImagenologia
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIFAHOv2.rptImagenologia.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptImagenologia
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptImagenologia = New rptImagenologia()
        rpt.Site = Me.Site
        Return rpt
    End Function
