...
Public Class rptExamenesLab
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Celer.rptExamenesLab.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptExamenesLab
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptExamenesLab = New rptExamenesLab()
        rpt.Site = Me.Site
        Return rpt
    End Function
