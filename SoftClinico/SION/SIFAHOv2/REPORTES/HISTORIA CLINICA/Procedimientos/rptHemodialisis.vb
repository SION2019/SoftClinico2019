...
Public Class rptHemodialisis
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIFAHOv2.rptHemodialisis.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptHemodialisis
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptHemodialisis = New rptHemodialisis()
        rpt.Site = Me.Site
        Return rpt
    End Function
