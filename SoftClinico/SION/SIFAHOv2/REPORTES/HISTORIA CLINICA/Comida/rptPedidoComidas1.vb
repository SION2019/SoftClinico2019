...
Public Class rptPedidoComidas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Celer.rptPedidoComidas.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_pIdEmpresa() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptPedidoComidas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPedidoComidas = New rptPedidoComidas()
        rpt.Site = Me.Site
        Return rpt
    End Function
