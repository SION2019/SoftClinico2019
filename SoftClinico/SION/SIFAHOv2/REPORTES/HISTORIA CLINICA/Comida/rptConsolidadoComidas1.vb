...
Public Class rptConsolidadoComidas1
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptConsolidadoComidas1.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIFAHOv2.rptConsolidadoComidas1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptConsolidadoComidas1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptConsolidadoComidas1 = New rptConsolidadoComidas1()
        rpt.Site = Me.Site
        Return rpt
    End Function
