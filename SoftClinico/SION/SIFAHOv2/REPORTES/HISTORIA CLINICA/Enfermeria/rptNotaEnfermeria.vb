...
Public Class rptNotaEnfermeria
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Celer.rptNotaEnfermeria.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptNotaEnfermeria
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptNotaEnfermeria = New rptNotaEnfermeria()
        rpt.Site = Me.Site
        Return rpt
    End Function
