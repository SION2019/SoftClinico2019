...
Public Class rptGlucometria
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Celer.rptGlucometria.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptGlucometria
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptGlucometria = New rptGlucometria()
        rpt.Site = Me.Site
        Return rpt
    End Function
