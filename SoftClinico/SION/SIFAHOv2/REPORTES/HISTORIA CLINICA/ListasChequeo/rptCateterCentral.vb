...
Public Class rptCateterCentral
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIFAHOv2.rptCateterCentral.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCateterCentral
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCateterCentral = New rptCateterCentral()
        rpt.Site = Me.Site
        Return rpt
    End Function
