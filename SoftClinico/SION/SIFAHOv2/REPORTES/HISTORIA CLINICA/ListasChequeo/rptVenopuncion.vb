...
Public Class rptVenopuncion
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIFAHOv2.rptVenopuncion.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptVenopuncion
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptVenopuncion = New rptVenopuncion()
        rpt.Site = Me.Site
        Return rpt
    End Function
