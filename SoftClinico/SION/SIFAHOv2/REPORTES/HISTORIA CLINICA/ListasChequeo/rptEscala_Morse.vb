...
Public Class rptEscala_Morse
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIFAHOv2.rptEscala_Morse.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptEscala_Morse
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptEscala_Morse = New rptEscala_Morse()
        rpt.Site = Me.Site
        Return rpt
    End Function
