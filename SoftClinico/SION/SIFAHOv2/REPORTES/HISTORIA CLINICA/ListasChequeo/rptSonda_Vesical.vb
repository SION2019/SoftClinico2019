...
Public Class rptSonda_Vesical
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIFAHOv2.rptSonda_Vesical.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptSonda_Vesical
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptSonda_Vesical = New rptSonda_Vesical()
        rpt.Site = Me.Site
        Return rpt
    End Function
