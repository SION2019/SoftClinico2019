...
Public Class rptRetiroVoluntario
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptRetiroVoluntario.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "G8LIAT.rptRetiroVoluntario.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptRetiroVoluntario
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptRetiroVoluntario = New rptRetiroVoluntario()
        rpt.Site = Me.Site
        Return rpt
    End Function
