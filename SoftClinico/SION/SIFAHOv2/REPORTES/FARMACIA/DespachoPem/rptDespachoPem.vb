...
Public Class rptDespachoPem
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Celer.rptDespachoPem.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptDespachoPem
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptDespachoPem = New rptDespachoPem()
        rpt.Site = Me.Site
        Return rpt
    End Function
