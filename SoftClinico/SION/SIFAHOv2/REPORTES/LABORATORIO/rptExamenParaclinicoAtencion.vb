...
Public Class rptExamenParaclinicoAtencion
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptExamenParaclinicoAtencion.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Celer.rptExamenParaclinicoAtencion.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_rptResultadoss_codigo_orden() As CrystalDecisions.[Shared].IParameterField
        Get
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_rptResultadoss_codigo_procedimiento() As CrystalDecisions.[Shared].IParameterField
        Get
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_rptResultadoss_tipo_Examen() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptExamenParaclinicoAtencion
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptExamenParaclinicoAtencion = New rptExamenParaclinicoAtencion()
        rpt.Site = Me.Site
        Return rpt
    End Function
