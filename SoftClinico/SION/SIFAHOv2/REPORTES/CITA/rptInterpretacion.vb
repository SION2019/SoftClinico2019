...
Public Class rptInterpretacion
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Celer.rptInterpretacion.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptInterpretacion
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptInterpretacion = New rptInterpretacion()
        rpt.Site = Me.Site
        Return rpt
    End Function
