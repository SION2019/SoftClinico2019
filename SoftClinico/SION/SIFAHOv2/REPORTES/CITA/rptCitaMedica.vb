...
Public Class rptCitaMedical
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Celer.rptCitaMedica.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCitaMedica
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCitaMedical = New rptCitaMedical
        rpt.Site = Me.Site
        Return rpt
    End Function
