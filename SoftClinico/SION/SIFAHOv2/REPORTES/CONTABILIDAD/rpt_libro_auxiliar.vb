...
Public Class rpt_libro_auxiliar
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIFAHOv2.rpt_libro_auxiliar.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_libro_auxiliar
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_libro_auxiliar = New rpt_libro_auxiliar()
        rpt.Site = Me.Site
        Return rpt
    End Function
